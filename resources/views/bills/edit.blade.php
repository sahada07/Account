    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold">Edit Bill: {{ $bill->bill_number }}</h2>
            ...
            <form action="{{ route('bills.update', $bill) }}" method="POST" id="billForm">
                ...
                <!-- Bill Items -->
                <div class="mt-6">
                    <h3 class="text-lg font-medium text-gray-700 mb-4">Bill Items</h3>
                    ...
                    <div class="mt-6 md:w-1/3 ml-auto">
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between text-lg font-bold">
                                <span>Total:</span>
                                <span id="total">${{ number_format($bill->total, 2) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="notes" 
                              id="notes" 
                              rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('notes', $bill->notes) }}</textarea>
                </div>
